...
export default class pastdue extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    requestgetHistoryComment(startTime, endTime) {
        ...
        var url = "pingji/getHistoryOverdue"
                ...
                <ScrollView style={{ flex: 1, backgroundColor: "#f4f4f4" }}>
                    <View>
                            ...
                            renderItem={({ item }) =>
                                <View style={{ backgroundColor: "#ffffff" }}>
                                    <View style={Styles.style_item}>
                                        ...
                                        <Text style={{ marginTop: scaleSizeH(15) }}>计划上门时间: {item.planservicetime}</Text>
                                        <Text style={{ marginTop: scaleSizeH(15) }}>计划上门时段: {item.duration}</Text>


                                        <Text style={{ marginTop: scaleSizeH(15) }}>保洁开始时间: {item.servicestarttime}</Text>
                                        <Text style={{ marginTop: scaleSizeH(15) }}>保洁结束时间: {item.serviceEndTime}</Text>
                        ...
                        {this.state.Commentdata == "" ? <Text></Text>
                            :
                            (<Text style={{ alignSelf: "center", marginTop: scaleSizeH(20), flex: 1, textAlign: "center" }}>当前数据共有{this.state.Commentdata.data.total}条逾期工单</Text>)}
