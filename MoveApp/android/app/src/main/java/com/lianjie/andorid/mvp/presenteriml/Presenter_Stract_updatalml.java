...
import com.lianjie.andorid.mvp.moudleiml.Moudle_Stract_updata;
 ...
 * Time: 16:01
 */
public class Presenter_Stract_updatalml implements IConstract_Stract.IPerenter {
    private IConstract_Stract.IModule Imoudle;
    private IConstract_Stract.IView Iview;

    public Presenter_Stract_updatalml(IConstract_Stract.IView iview) {
        Iview = iview;
        this.Imoudle = new Moudle_Stract_updata();
        this.Iview = iview;
    }

    @Override
    public void setData(Map<String, Object> map) {
        Imoudle.getData(new NetWorkCallBack<UpdataBean>() {
            @Override
            public void onSucess(UpdataBean subaudBean) {
