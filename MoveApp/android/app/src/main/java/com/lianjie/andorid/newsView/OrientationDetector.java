...
public class OrientationDetector {
    ...
    private Direction lastDirection = OrientationDetector.Direction.PORTRAIT;
        ...
        if (orientationEventListener == null) {
            orientationEventListener = new OrientationEventListener(context, SensorManager.SENSOR_DELAY_UI) {
                ...
                public void onOrientationChanged(int orientation) {
                  OrientationDetector.Direction currDirection = calcDirection(orientation);
                    ...
                    if (currDirection != lastDirection) {
                        ...
                        if (holdingTime > HOLDING_THRESHOLD) {
                            ...
                            } else if (currDirection == OrientationDetector.Direction.REVERSE_LANDSCAPE) {
...
//      Log.d(TAG, "calcHoldingTime holdingTime=" + holdingTime);
    ...
    private OrientationDetector.Direction calcDirection(int orientation) {
    ...
    public void setInitialDirection(OrientationDetector.Direction direction) {
